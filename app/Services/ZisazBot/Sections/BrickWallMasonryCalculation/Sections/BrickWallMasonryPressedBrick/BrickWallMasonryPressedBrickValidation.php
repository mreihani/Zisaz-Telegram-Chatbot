...
class BrickWallMasonryPressedBrickValidation extends BrickWallMasonryPressedBrickCalculation {
    ...
    public function isNumericValidation($text, $paramType) {
        if(!is_numeric($text)) {
            ...
            $brickWallMasonryPressedBrick = new BrickWallMasonryPressedBrickBotResponse($this->telegram);

            $this->switchValidation($brickWallMasonryPressedBrick, $paramType);
